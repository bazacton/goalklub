 ...
 */
 global $cs_node,$post,$cs_theme_options,$cs_counter_node,$post_xml, $atts;
...
<div class="banner" style=" <?php echo cs_allow_special_char($section_bg); ?> margin:-41px 0 35px 0; background-position:center;">
        <div class="banner-inn post-<?php echo esc_attr( $post->ID );?>">
                                ...
                                <li>
                                  <div class="match-score">
                                   ...
                                   <?php if ( isset( $cs_match_attendance ) && $cs_match_attendance !='' ){?> 
                                    <ul>
                                        <li><i class="icon-group"></i><?php _e('Attendance','goalklub');?><?php echo esc_attr( $cs_match_attendance );?></li>
                                    </ul>
                                   <?php }?>
                                  </div>
                                </li>
            ...
            <div class="bottom-event-panel">
                <ul class="post-option">
                     	<li><?php $matchObject->cs_get_categories( $atts['cs_match_cat'] );?></li>
