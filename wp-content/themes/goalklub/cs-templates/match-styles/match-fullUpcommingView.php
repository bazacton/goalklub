...
<div class="banner match-detail-full" style=" <?php echo cs_allow_special_char($section_bg); ?> margin:-41px 0 35px 0; background-position:center;">
        <div class="banner-inn post-<?php echo esc_attr( $post->ID );?>">
            <div class="container">
                <div class="countdownit">
                  <div id="matchCountdown"></div>
                </div>
                <div class="banner-top">
                    <div class="featured-event event-editor hello 2">
                         <style>
                                ...
                                <li>
                                    <figure>
									  ...
									  <?php if ( isset( $team_name_1 ) && $team_name_1 !='' ){?> 
                                		<a><figcaption><?php echo esc_attr( $team_name_1 );?></a></figcaption>
                                	  <?php }?>
                                    </figure>
                                </li>
                                <li>
                                ...
                                <li class="right-side">
                                    <figure>
									  ...
									  <?php if ( isset( $team_name_2 ) && $team_name_2 !='' ){?> 
                                		<a><figcaption><?php echo esc_attr( $team_name_2 );?></a></figcaption>
                                	  <?php }?>
                                    </figure>
                                </li>
                            </ul>
            ...
            <div class="bottom-event-panel panel-full-width">
				<div class="container">
					...
					<a <?php echo force_back( $background, false ); ?> href="<?php echo esc_url( $cs_match_buy_now ); ?>" class="ticket-btn cs-bgcolor">
						<?php
                       $b =  $cs_match_ticket_title ? $cs_match_ticket_title : 'Tickets';
                        echo esc_html($b); ?>
                    </a>
				</div>               
            </div>
