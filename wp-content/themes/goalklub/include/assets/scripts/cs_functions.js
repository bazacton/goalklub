...
function cs_service_toggle_view(value, id, object) {
	...
	if (value == "modern") {
		...
		jQuery("#cs-modern-bg-color-"+id).show();
		...
		jQuery("#cs-modern-bg-color-"+id).hide();
	}
...
function show_sidebar_page(id) {
	...
	if ((id == 'left') || (id == 'right') ) {
		...
		$("#sidebar_"+id).show();
		$("#sidebar_styling").show();
		$("#sidebar_styling_color").show();
	}  else if (id == 'both') {
		...
		$("#sidebar_styling").hide();
		$("#sidebar_styling_color").hide();
	}
}

function cs_sidebar_styling(style) {
	if (style == 'color') {
		jQuery("#sidebar_styling_color").show();
	} else {
		jQuery("#sidebar_styling_color").hide();
...
var Data = [{
	"Class": "column_100",	"title": "100",	"element": ["gallery", "slider", "blog","event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"]}, 
	{"Class": "column_75","title": "75",	"element": ["gallery", "slider", "blog", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box", "image_frame",'image', "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"]}, 
	{"Class": "column_67","title": "67","element": ["gallery", "slider", "blog", "event", "team", "column", "accordions", "team", "client", "contact", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","clients","spacer","heading","testimonials","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"]}, 
	{"Class": "column_50","title": "50","element": ["gallery", "slider", "blog", "event", "team", "column", "services", "accordions", "team", "client", "contact", "column", "divider", "message_box", "image_frame",'image', "map", "video", "quote", "dropcap", "pricetable", "services", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"]},
	{"Class": "column_33","title": "33","element": ["gallery", "slider","blog", "event", "team", "column", "accordions", "message_box",'image', "fixtures", "map", "video", "quote", "dropcap", "pricetable", "services", "tabs", "accordion", "prayer", "pointtable","flex_column","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","fixture","point_table","contactinfo"]}, 
	{"Class": "column_25","title": "25","element": ["column", "divider", "message_box", "image_frame", "map", "video", "quote", "dropcap", "pricetable", "services", "pastor",'services','counter',"flex_column","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","upcomming_fixtures","contactinfo"]}, ];
...
var counter_point_table = 0;
function add_pointtable_to_list(admin_url, theme_url) {
	counter_point_table++;
	var dataString = 'counter_point_table='+counter_point_table+
		'&point_table_column_title1='+jQuery("#point_table_column_title1").val()+
		'&point_table_column_title2='+jQuery("#point_table_column_title2").val()+
		'&point_table_column_title3='+jQuery("#point_table_column_title3").val()+
		'&point_table_column_title4='+jQuery("#point_table_column_title4").val()+
		'&point_table_column_title5='+jQuery("#point_table_column_title5").val()+
		'&point_table_column_title6='+jQuery("#point_table_column_title6").val()+
		'&point_table_column_title7='+jQuery("#point_table_column_title7").val()+
		'&point_table_column_title8='+jQuery("#point_table_column_title8").val()+
		'&point_table_column_title9='+jQuery("#point_table_column_title9").val()+
		'&point_table_column_title10='+jQuery("#point_table_column_title10").val()+
		'&point_table_column_feature='+jQuery("#point_table_column_feature").val()+
		'&point_table_i='+jQuery("#point_table_i").val()+
		'&action=cs_add_point_tables_to_list';
	jQuery("#loading").html("<img src='" + theme_url + "/include/assets/images/ajax_loading.gif' />");
	jQuery.ajax({
		type: "POST",
		url: admin_url,
		data: dataString,
		success: function(response) {
			jQuery("#total_pointtable_fields").append(response);
			jQuery("#loading").html("");
			removeoverlay('add_pointtable_title', 'append');
			jQuery("#point_table_column_title1,#point_table_column_title2,#point_table_column_title3,#point_table_column_title4,#point_table_column_title5,#point_table_column_title6,#point_table_column_title7,#point_table_column_title8,#point_table_column_title9,#point_table_column_title10").val("");
			jQuery("#point_table_column_feature").val('No');
		}
	});
	return false;
}

function cs_point_table_seleted(value, admin_url, theme_url) {
	var dataString = 'table_set_value=' + value +
		'&action=cs_point_table_seleted';
	jQuery("#total_selected_pointtable_fields").html("<img src='" + theme_url + "/include/assets/images/ajax_loading.gif' />");
	jQuery.ajax({
		type: "POST",
		url: admin_url,
		data: dataString,
		success: function(response) {
			jQuery("#total_selected_pointtable_fields").html(response);
		}
	});
	return false;
}
...
var counter_score = 0;
function add_score_to_list(admin_url, theme_url) {
	counter_score++;
	var dataString = 'counter_score='+counter_score+
		'&match_score_time='+jQuery("#match_score_time").val()+
		'&match_palyer_name='+jQuery("#match_palyer_name").val()+
		'&match_score_color='+jQuery("#match_score_color").val()+
		'&match_score_description='+jQuery("#match_score_description").val()+
		'&action=cs_add_score_to_list';
	jQuery("#loading").html("<img src='" + theme_url + "/include/assets/images/ajax_loading.gif' />");
	jQuery.ajax({
		type: "POST",
		url: admin_url,
		data: dataString,
		success: function(response) {
			jQuery("#total_scorelist_fields").append(response);
			jQuery("#loading").html("");
			removeoverlay('add_scorelist_title', 'append');
			jQuery('#match_score_time,#match_palyer_name,#match_score_color,#match_score_description').val('');
		}
	});
	return false;
}
