		...
		var Data = [
			{ "Class" : "column_100" , "title":"100" , "element" : ["gallery", "slider","blog", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"] },
			{ "Class" : "column_75" , "title" : "75" , "element" : ["gallery", "slider", "blog","team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"] },
			{ "Class" : "column_67" , "title" : "67" , "element" : ["gallery", "slider", "blog","team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"] },
			{ "Class" : "column_50" , "title" : "50" , "element" : ["gallery", "slider", "blog","team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","tabs", "accordion", "advance_search", "prayer","teams","services","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","project","tooltip","highlight","list","mesage","faq","counter","match","player","point_table","upcomming_fixtures","contactinfo","club_history"] },
			{ "Class" : "column_33" , "title" : "33" , "element" : ["gallery", "slider","blog",  "team", "column", "accordions", "message_box",'image', "fixtures", "map", "video", "quote", "dropcap","services", "tabs", "accordion","prayer", "pointtable", "teams","flex_column", "pricetable","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","upcomming_fixtures","point_table","contactinfo"] },
			{ "Class" : "column_25" , "title" : "25" , "element" : ["gallery","column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","pastor","services","counter","teams",'services',"flex_column","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq","upcomming_fixtures","contactinfo"] },
		];
...
//                                        jQuery('#postdivrich').append(_structure);
		...
		jQuery(window).on('popstate', function() {
				...
				jQuery('a[href=' + anchor + ']').tab('show');
                        ...
                        jQuery(document).on('click','.webfonts-wrapper li',function() {
					var _this = jQuery(this),
			...
			function SuccessLoader() {
				...
				var loader = "<div class='loader'><i class='icon-spin icon-spinner'></i></div>"
