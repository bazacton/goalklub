...
function cs_google_font_att(admin_url, att_id, id){
	...
	if ( att_id != "" ) {
		...
		jQuery('#'+id).parent().parent().append('<i style="font-size:20px;color:#ff6363;" class="icon-spin icon-circle-o-notch"></i>');
...
var counter_player_field = 0;
function cs_add_player_fields(admin_url){
	counter_player_field++;
	var player_field = jQuery("#player_field_input").val();
	var player_field_value =  jQuery("#player_field_value_input").val();
	if ( player_field != "" && player_field_value != "" ) {
		var dataString = 'player_field=' + player_field + 
						'&player_field_value=' + player_field_value +
						'&action=cs_add_player_fields';
		jQuery.ajax({
			type:"POST",
			url: admin_url,
			data: dataString,
			success:function(response){
				jQuery("#cs_player_fields").append(response);
				jQuery(".player-fields-area").show(200);
				jQuery("#player_field_input,#player_field_value_input").val("");
			}
		});
		//return false;
	}
...
var counter_point_table_column = 0;
function cs_add_table_columns(admin_url){
	counter_point_table_column++;
	var table_points_columns = jQuery("#table_points_columns_input").val();
	var table_column_title1 =  jQuery("#table_column_title1_input").val();
	var table_column_title2 =  jQuery("#table_column_title2_input").val();
	var table_column_title3 =  jQuery("#table_column_title3_input").val();
	var table_column_title4 =  jQuery("#table_column_title4_input").val();
	var table_column_title5 =  jQuery("#table_column_title5_input").val();
	var table_column_title6 =  jQuery("#table_column_title6_input").val();
	var table_column_title7 =  jQuery("#table_column_title7_input").val();
	var table_column_title8 =  jQuery("#table_column_title8_input").val();
	var table_column_title9 =  jQuery("#table_column_title9_input").val();
	var table_column_title10 =  jQuery("#table_column_title10_input").val();
	if ( table_points_columns != "" ) {
		var dataString = 'table_points_columns=' + table_points_columns + 
						'&table_column_title1=' + table_column_title1 +
						'&table_column_title2=' + table_column_title2 +
						'&table_column_title3=' + table_column_title3 +
						'&table_column_title4=' + table_column_title4 +
						'&table_column_title5=' + table_column_title5 +
						'&table_column_title6=' + table_column_title6 +
						'&table_column_title7=' + table_column_title7 +
						'&table_column_title8=' + table_column_title8 +
						'&table_column_title9=' + table_column_title9 +
						'&table_column_title10=' + table_column_title10 +
						'&action=cs_add_table_columns';
		jQuery.ajax({
			type:"POST",
			url: admin_url,
			data: dataString,
			success:function(response){
				jQuery("#cs_table_columns_fields").append(response);
				jQuery(".table-columns-area").show(200);
				jQuery("#table_points_columns_input,#table_column_title1_input,#table_column_title2_input,#table_column_title3_input,#table_column_title4_input,#table_column_title5_input,#table_column_title6_input,#table_column_title7_input,#table_column_title8_input,#table_column_title9_input,#table_column_title10_input").val("");
			}
		});
		//return false;
	}
        ...
        function add_sidebar(){
            ...
            if ( sidebar_input != "" ) {
                jQuery("#sidebar_area").append('<tr id="'+counter_sidebar+'"> \
                            ...
                            <td class="centr"> <a class="remove-btn" onclick="javascript:return confirm(\'Are you sure! You want to delete this\')" href="javascript:cs_div_remove('+counter_sidebar+')"><i class="icon-cross3"></i></a> </td> \
                        </tr>');
