...
if (function_exists('cs_meta_boxes')) {
    ...
    cs_meta_boxes('cs_page_options_add');
}

function cs_page_options_add() {
    if (function_exists('cs_meta_box')) {
        cs_meta_box('id_page_options', __('CS Page Options','goalklub'), 'cs_page_options', 'page', 'normal', 'high' );
    }
}
function cs_page_bulider_add() {
    if (function_exists('cs_meta_box')) {
        cs_meta_box('id_page_builder', __('CS Page Builder','goalklub'), 'cs_page_bulider', 'page', 'normal', 'high' );
    }
}  
...
?>
    ...
    <!-- <div id="no_widget" class="placehoder">Page Builder in Empty, Please Select Page Element. <img src="<?php echo get_template_directory_uri()?>/include/assets/images/bg-arrowup.png" alt="No image" /></div> -->
    <?php //}?>
  </div>
   <div class="clear"></div>
   <div class="add-widget"> <span class="addwidget"> <a href="javascript:ajaxSubmit('cs_column_pb','1','column_full')"><i class="icon-plus7"></i> <?php esc_html_e('Add new Section', 'goalklub'); ?></a> </span>
		...
		<div class="tabs vertical">
        	<nav class="admin-navigtion">
               <ul id="myTab" class="nav nav-tabs">
                 <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="icon-gear"></i> <?php _e('General Settings','goalklub');?></a></li>
                 <li><a href="#tab-slideshow" data-toggle="tab"><i class="icon-header"></i> <?php _e('Sub header','goalklub');?></a></li>
				...
				if ( isset($_POST['builder_active']) ) {
					...
					$sxe = cs_page_options_save_xml($sxe);
								//if ( isset($_POST['cs_orderby']) ) {
									...
									$cs_global_counter_match = 0;
									$cs_shortcode_counter_match = 0;
									$cs_counter_match = 0;
									
									$cs_global_counter_fixture = 0;
									$cs_shortcode_counter_fixture = 0;
									$cs_counter_fixture = 0;
									
									$cs_global_counter_player = 0;
									$cs_shortcode_counter_player = 0;
									$cs_counter_player = 0;
									
									$cs_global_counter_point_table = 0;
									$cs_shortcode_counter_point_table = 0;
									$cs_counter_point_table = 0;
									
									$cs_global_counter_contactinfo = 0;
									$cs_shortcode_counter_contactinfo = 0;
									$cs_counter_contactinfo = 0;
									
									$cs_global_counter_club_history = 0;
									$cs_shortcode_counter_club_history = 0;
									$counter_club_history_node = 0;
									$counter_club_history = 0;
										...
										// Common Elements Start
											...
											// Services
													...
													if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
														...
														if(isset($_POST['cs_service_border'][$cs_counter_services]) && $_POST['cs_service_border'][$cs_counter_services] != ''){
															$shortcode_item .= 	'cs_service_border="'.htmlspecialchars($_POST['cs_service_border'][$cs_counter_services]).'" ';
														}
														...
														if(isset($_POST['cs_service_btn_color'][$cs_counter_services]) && $_POST['cs_service_btn_color'][$cs_counter_services] != ''){
															$shortcode_item .= 	'cs_service_btn_color="'.htmlspecialchars($_POST['cs_service_btn_color'][$cs_counter_services], ENT_QUOTES).'" ';
														}
							...
							// Media Elements Shortcode
											...
											else if ( $_POST['cs_orderby'][$cs_counter] == "club_history" ) {
												$shortcode = $shortcode_item = '';
												$club_history = $column->addChild('club_history');
												$club_history->addChild('page_element_size', htmlspecialchars($_POST['club_history_element_size'][$cs_global_counter_club_history]) );
												$club_history->addChild('club_history_element_size', htmlspecialchars($_POST['club_history_element_size'][$cs_global_counter_club_history]) );
												
												if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
													$shortcode_str = stripslashes ($_POST['shortcode']['club_history'][$cs_shortcode_counter_club_history]);
													$cs_shortcode_counter_club_history++;
													$club_history->addChild('cs_shortcode', htmlspecialchars($shortcode_str, ENT_QUOTES) );
												} else {
													if(isset($_POST['club_history_num'][$counter_club_history]) && $_POST['club_history_num'][$counter_club_history]>0){			
														for ( $i = 1; $i <= $_POST['club_history_num'][$counter_club_history]; $i++ ){
																$shortcode_item .= '[club_history_item ';
																if(isset($_POST['club_history_title'][$counter_club_history_node]) && $_POST['club_history_title'][$counter_club_history_node] != ''){
																	$shortcode_item .= 	'club_history_title="'.htmlspecialchars($_POST['club_history_title'][$counter_club_history_node], ENT_QUOTES).'" ';
																}
																if(isset($_POST['cs_club_history_image'][$counter_club_history_node]) && $_POST['cs_club_history_image'][$counter_club_history_node] != ''){
																	$shortcode_item .= 	'cs_club_history_image="'.htmlspecialchars($_POST['cs_club_history_image'][$counter_club_history_node]).'" ';
																}
																if(isset($_POST['club_history_icon'][$counter_club_history_node]) && $_POST['club_history_icon'][$counter_club_history_node] != ''){
																	$shortcode_item .= 	'club_history_icon="'.htmlspecialchars($_POST['club_history_icon'][$counter_club_history_node]).'" ';
																}
																if(isset($_POST['club_history_year'][$counter_club_history_node]) && $_POST['club_history_year'][$counter_club_history_node] != ''){
																	$shortcode_item .= 	'club_history_year="'.htmlspecialchars($_POST['club_history_year'][$counter_club_history_node]).'" ';
																}															
																$shortcode_item .= 	']';
																if(isset($_POST['club_history_text'][$counter_club_history_node]) && $_POST['club_history_text'][$counter_club_history_node] != ''){
																	$shortcode_item .= 	htmlspecialchars($_POST['club_history_text'][$counter_club_history_node], ENT_QUOTES);
																}
																$shortcode_item .= 	'[/club_history_item]'; 
																	 
																$counter_club_history_node++;
															}
													}
													
													$shortcode = '[cs_club_history '.$section_title;
													if(isset($_POST['cs_club_history_section_title'][$counter_club_history]) && $_POST['cs_club_history_section_title'][$counter_club_history] != ''){
														$shortcode .=	'cs_club_history_section_title="'.htmlspecialchars($_POST['cs_club_history_section_title'][$counter_accordion], ENT_QUOTES).'" ';
													}
													if(isset($_POST['cs_club_history_view'][$counter_club_history]) && $_POST['cs_club_history_view'][$counter_club_history] != ''){
														$shortcode .= 	'cs_club_history_view="'.htmlspecialchars($_POST['cs_club_history_view'][$counter_accordion]).'" ';
													}
													if(isset($_POST['cs_club_history_class'][$counter_club_history]) && $_POST['cs_club_history_class'][$counter_club_history] != ''){
														$shortcode .= 	' cs_club_history_class="'.htmlspecialchars($_POST['cs_club_history_class'][$counter_club_history]).'" ';
													}
													if(isset($_POST['cs_club_history_animation'][$counter_club_history]) && $_POST['cs_club_history_animation'][$counter_club_history] != ''){
														$shortcode .= 	' cs_club_history_animation="'.htmlspecialchars($_POST['cs_club_history_animation'][$counter_club_history]).'" ';
													}
													$shortcode .= ']'.$shortcode_item.'[/cs_club_history]';
													
													$club_history->addChild('cs_shortcode', $shortcode );
													$counter_club_history++;
												}
												$cs_global_counter_club_history++;
											}
										...
										// match
										else if ( $_POST['cs_orderby'][$cs_counter] == "match" ) {
													$shortcode = '';
													$match = $column->addChild('match');
													$match->addChild('page_element_size', htmlspecialchars($_POST['match_element_size'][$cs_global_counter_match]) );
													$match->addChild('match_element_size', htmlspecialchars($_POST['match_element_size'][$cs_global_counter_match]) );
													if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
														$shortcode_str = stripslashes ($_POST['shortcode']['match'][$cs_shortcode_counter_match]);
														$cs_shortcode_counter_match++;
														$match->addChild('cs_shortcode', htmlspecialchars($shortcode_str) );
													} else {
														$shortcode = '[cs_match ';
														if(isset($_POST['cs_match_section_title'][$cs_counter_match]) && $_POST['cs_match_section_title'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_section_title="'.htmlspecialchars($_POST['cs_match_section_title'][$cs_counter_match], ENT_QUOTES).'" ';
														}
														if(isset($_POST['cs_match_view'][$cs_counter_match]) && $_POST['cs_match_view'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_view="'.htmlspecialchars($_POST['cs_match_view'][$cs_counter_match]).'" ';
														}if(isset($_POST['cs_match_num_post'][$cs_counter_match]) && $_POST['cs_match_num_post'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_num_post="'.htmlspecialchars($_POST['cs_match_num_post'][$cs_counter_match]).'" ';
														}if(isset($_POST['cs_match_cat'][$cs_counter_match]) && $_POST['cs_match_cat'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_cat="'.htmlspecialchars($_POST['cs_match_cat'][$cs_counter_match]).'" ';
														}if(isset($_POST['cs_match_type'][$cs_counter_match]) && $_POST['cs_match_type'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_type="'.htmlspecialchars($_POST['cs_match_type'][$cs_counter_match]).'" ';
														}if(isset($_POST['cs_match_order'][$cs_counter_match]) && $_POST['cs_match_order'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_order="'.htmlspecialchars($_POST['cs_match_order'][$cs_counter_match]).'" ';
														}if(isset($_POST['match_pagination'][$cs_counter_match]) && $_POST['match_pagination'][$cs_counter_match] != ''){
															$shortcode .= 	'match_pagination="'.htmlspecialchars($_POST['match_pagination'][$cs_counter_match]).'" ';
														}if(isset($_POST['cs_match_class'][$cs_counter_match]) && $_POST['cs_match_class'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_class="'.htmlspecialchars($_POST['cs_match_class'][$cs_counter_match], ENT_QUOTES).'" ';
														}if(isset($_POST['cs_match_animation'][$cs_counter_match]) && $_POST['cs_match_animation'][$cs_counter_match] != ''){
															$shortcode .= 	'cs_match_animation="'.htmlspecialchars($_POST['cs_match_animation'][$cs_counter_match]).'" ';
														}
														$shortcode .= 	']';
														$match->addChild('cs_shortcode', $shortcode );
														$cs_counter_match++;
													}
												$cs_global_counter_match++;
										}
										
										// Upcomming Fixtures
										else if ( $_POST['cs_orderby'][$cs_counter] == "upcomming_fixtures" ) {
											$shortcode = '';
											$fixtures = $column->addChild('upcomming_fixtures');
											$fixtures->addChild('page_element_size', htmlspecialchars($_POST['upcomming_fixtures_element_size'][$cs_global_counter_fixture]) );
											$fixtures->addChild('fixture_element_size', htmlspecialchars($_POST['upcomming_fixtures_element_size'][$cs_global_counter_fixture]) );
											if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
												$shortcode_str = stripslashes ($_POST['shortcode']['upcomming_fixtures'][$cs_shortcode_counter_fixture]);
												$cs_shortcode_counter_fixture++;
												$fixtures->addChild('cs_shortcode', htmlspecialchars($shortcode_str) );
											} else {
												$shortcode = '[cs_upcomming_fixtures ';
												if(isset($_POST['cs_fixture_section_title'][$cs_counter_fixture]) && $_POST['cs_fixture_section_title'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_section_title="'.htmlspecialchars($_POST['cs_fixture_section_title'][$cs_counter_fixture], ENT_QUOTES).'" ';
												}
												if(isset($_POST['cs_fixture_num_post'][$cs_counter_fixture]) && $_POST['cs_fixture_num_post'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_num_post="'.htmlspecialchars($_POST['cs_fixture_num_post'][$cs_counter_fixture]).'" ';
												}if(isset($_POST['cs_fixture_cat'][$cs_counter_fixture]) && $_POST['cs_fixture_cat'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_cat="'.htmlspecialchars($_POST['cs_fixture_cat'][$cs_counter_fixture]).'" ';
												}if(isset($_POST['cs_fixture_view'][$cs_counter_fixture]) && $_POST['cs_fixture_view'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_view="'.htmlspecialchars($_POST['cs_fixture_view'][$cs_counter_fixture]).'" ';
												}if(isset($_POST['cs_fixture_order'][$cs_counter_fixture]) && $_POST['cs_fixture_order'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_order="'.htmlspecialchars($_POST['cs_fixture_order'][$cs_counter_fixture]).'" ';
												}if(isset($_POST['fixture_pagination'][$cs_counter_fixture]) && $_POST['fixture_pagination'][$cs_counter_fixture] != ''){
													$shortcode .= 	'fixture_pagination="'.htmlspecialchars($_POST['fixture_pagination'][$cs_counter_fixture]).'" ';
												}if(isset($_POST['cs_fixture_link'][$cs_counter_fixture]) && $_POST['cs_fixture_link'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_link="'.htmlspecialchars($_POST['cs_fixture_link'][$cs_counter_fixture]).'" ';
												}if(isset($_POST['cs_fixture_class'][$cs_counter_fixture]) && $_POST['cs_fixture_class'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_class="'.htmlspecialchars($_POST['cs_fixture_class'][$cs_counter_fixture], ENT_QUOTES).'" ';
												}if(isset($_POST['cs_fixture_animation'][$cs_counter_fixture]) && $_POST['cs_fixture_animation'][$cs_counter_fixture] != ''){
													$shortcode .= 	'cs_fixture_animation="'.htmlspecialchars($_POST['cs_fixture_animation'][$cs_counter_fixture]).'" ';
												}
												$shortcode .= 	']';
												$fixtures->addChild('cs_shortcode', $shortcode );
												$cs_counter_fixture++;
											}
										$cs_global_counter_fixture++;
										}
										
										// Player
										else if ( $_POST['cs_orderby'][$cs_counter] == "player" ) {
													$shortcode = '';
													$player = $column->addChild('player');
													$player->addChild('page_element_size', htmlspecialchars($_POST['player_element_size'][$cs_global_counter_player]) );
													$player->addChild('player_element_size', htmlspecialchars($_POST['player_element_size'][$cs_global_counter_player]) );
													if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
														$shortcode_str = stripslashes ($_POST['shortcode']['player'][$cs_shortcode_counter_player]);
														$cs_shortcode_counter_player++;
														$player->addChild('cs_shortcode', htmlspecialchars($shortcode_str) );
													} else {
														$shortcode = '[cs_player ';
														if(isset($_POST['cs_player_section_title'][$cs_counter_player]) && $_POST['cs_player_section_title'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_section_title="'.htmlspecialchars($_POST['cs_player_section_title'][$cs_counter_player], ENT_QUOTES).'" ';
														}
														if(isset($_POST['cs_player_view'][$cs_counter_player]) && $_POST['cs_player_view'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_view="'.htmlspecialchars($_POST['cs_player_view'][$cs_counter_player]).'" ';
														}if(isset($_POST['cs_player_num_post'][$cs_counter_player]) && $_POST['cs_player_num_post'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_num_post="'.htmlspecialchars($_POST['cs_player_num_post'][$cs_counter_player]).'" ';
														}if(isset($_POST['cs_player_team'][$cs_counter_player]) && $_POST['cs_player_team'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_team="'.htmlspecialchars($_POST['cs_player_team'][$cs_counter_player]).'" ';
														}if(isset($_POST['cs_player_department'][$cs_counter_player]) && $_POST['cs_player_department'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_department="'.htmlspecialchars($_POST['cs_player_department'][$cs_counter_player]).'" ';
														}if(isset($_POST['cs_player_order'][$cs_counter_player]) && $_POST['cs_player_order'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_order="'.htmlspecialchars($_POST['cs_player_order'][$cs_counter_player]).'" ';
														}if(isset($_POST['cs_player_filter'][$cs_counter_player]) && $_POST['cs_player_filter'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_filter="'.htmlspecialchars($_POST['cs_player_filter'][$cs_counter_player]).'" ';
														}if(isset($_POST['player_pagination'][$cs_counter_player]) && $_POST['player_pagination'][$cs_counter_player] != ''){
															$shortcode .= 	'player_pagination="'.htmlspecialchars($_POST['player_pagination'][$cs_counter_player]).'" ';
														}if(isset($_POST['cs_player_class'][$cs_counter_player]) && $_POST['cs_player_class'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_class="'.htmlspecialchars($_POST['cs_player_class'][$cs_counter_player], ENT_QUOTES).'" ';
														}if(isset($_POST['cs_player_animation'][$cs_counter_player]) && $_POST['cs_player_animation'][$cs_counter_player] != ''){
															$shortcode .= 	'cs_player_animation="'.htmlspecialchars($_POST['cs_player_animation'][$cs_counter_player]).'" ';
														}
														$shortcode .= 	']';
														$player->addChild('cs_shortcode', $shortcode );
														$cs_counter_player++;
													}
												$cs_global_counter_player++;
										}
										
										// Point Table
										else if ( $_POST['cs_orderby'][$cs_counter] == "point_table" ) {
													$shortcode = '';
													$point_table = $column->addChild('point_table');
													$point_table->addChild('page_element_size', htmlspecialchars($_POST['point_table_element_size'][$cs_global_counter_point_table]) );
													$point_table->addChild('point_table_element_size', htmlspecialchars($_POST['point_table_element_size'][$cs_global_counter_point_table]) );
													if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
														$shortcode_str = stripslashes ($_POST['shortcode']['point_table'][$cs_shortcode_counter_point_table]);
														$cs_shortcode_counter_point_table++;
														$point_table->addChild('cs_shortcode', htmlspecialchars($shortcode_str) );
													} else {
														$shortcode = '[cs_point_table ';
														if(isset($_POST['cs_point_table_section_title'][$cs_counter_point_table]) && $_POST['cs_point_table_section_title'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_section_title="'.htmlspecialchars($_POST['cs_point_table_section_title'][$cs_counter_point_table], ENT_QUOTES).'" ';
														}
														if(isset($_POST['cs_point_table_num_post'][$cs_counter_point_table]) && $_POST['cs_point_table_num_post'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_num_post="'.htmlspecialchars($_POST['cs_point_table_num_post'][$cs_counter_point_table]).'" ';
														}if(isset($_POST['cs_point_table_category'][$cs_counter_point_table]) && $_POST['cs_point_table_category'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_category="'.htmlspecialchars($_POST['cs_point_table_category'][$cs_counter_point_table]).'" ';
														}if(isset($_POST['cs_point_table_order'][$cs_counter_point_table]) && $_POST['cs_point_table_order'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_order="'.htmlspecialchars($_POST['cs_point_table_order'][$cs_counter_point_table]).'" ';
														}if(isset($_POST['cs_point_table_filter'][$cs_counter_point_table]) && $_POST['cs_point_table_filter'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_filter="'.htmlspecialchars($_POST['cs_point_table_filter'][$cs_counter_point_table]).'" ';
														}if(isset($_POST['point_table_pagination'][$cs_counter_point_table]) && $_POST['point_table_pagination'][$cs_counter_point_table] != ''){
															$shortcode .= 	'point_table_pagination="'.htmlspecialchars($_POST['point_table_pagination'][$cs_counter_point_table]).'" ';
														}if(isset($_POST['cs_point_table_class'][$cs_counter_point_table]) && $_POST['cs_point_table_class'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_class="'.htmlspecialchars($_POST['cs_point_table_class'][$cs_counter_point_table], ENT_QUOTES).'" ';
														}if(isset($_POST['cs_point_table_animation'][$cs_counter_point_table]) && $_POST['cs_point_table_animation'][$cs_counter_point_table] != ''){
															$shortcode .= 	'cs_point_table_animation="'.htmlspecialchars($_POST['cs_point_table_animation'][$cs_counter_point_table]).'" ';
														}
														$shortcode .= 	']';
														$point_table->addChild('cs_shortcode', $shortcode );
														$cs_counter_point_table++;
													}
												$cs_global_counter_point_table++;
										}
										
										// Contact Info
										else if ( $_POST['cs_orderby'][$cs_counter] == "contactinfo" ) {
													$shortcode = '';
													$contactinfo = $column->addChild('contactinfo');
													$contactinfo->addChild('page_element_size', htmlspecialchars($_POST['contactinfo_element_size'][$cs_global_counter_contactinfo]) );
													$contactinfo->addChild('contactinfo_element_size', htmlspecialchars($_POST['contactinfo_element_size'][$cs_global_counter_contactinfo]) );
													if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
														$shortcode_str = stripslashes ($_POST['shortcode']['contactinfo'][$cs_shortcode_counter_contactinfo]);
														$cs_shortcode_counter_contactinfo++;
														$contactinfo->addChild('cs_shortcode', htmlspecialchars($shortcode_str) );
													} else {
														$shortcode = '[cs_contactinfo ';
														if(isset($_POST['cs_contact_section_title'][$cs_counter_contactinfo]) && $_POST['cs_contact_section_title'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_section_title="'.htmlspecialchars($_POST['cs_contact_section_title'][$cs_counter_contactinfo], ENT_QUOTES).'" ';
														}
														if(isset($_POST['cs_contact_image'][$cs_counter_contactinfo]) && $_POST['cs_contact_image'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_image="'.htmlspecialchars($_POST['cs_contact_image'][$cs_counter_contactinfo]).'" ';
														}
                                                        if(isset($_POST['cs_contact_phone'][$cs_counter_contactinfo]) && $_POST['cs_contact_phone'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_phone="'.htmlspecialchars($_POST['cs_contact_phone'][$cs_counter_contactinfo]).'" ';
														}
                                                        if(isset($_POST['cs_contact_email'][$cs_counter_contactinfo]) && $_POST['cs_contact_email'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_email="'.htmlspecialchars($_POST['cs_contact_email'][$cs_counter_contactinfo]).'" ';
														}
                                                        if(isset($_POST['cs_contact_fax'][$cs_counter_contactinfo]) && $_POST['cs_contact_fax'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_fax="'.htmlspecialchars($_POST['cs_contact_fax'][$cs_counter_contactinfo]).'" ';
														}
                                                        if(isset($_POST['cs_contact_web'][$cs_counter_contactinfo]) && $_POST['cs_contact_web'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_web="'.htmlspecialchars($_POST['cs_contact_web'][$cs_counter_contactinfo]).'" ';
														}
                                                        if(isset($_POST['cs_contact_class'][$cs_counter_contactinfo]) && $_POST['cs_contact_class'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_class="'.htmlspecialchars($_POST['cs_contact_class'][$cs_counter_contactinfo]).'" ';
														}
                                                        if(isset($_POST['cs_contact_animation'][$cs_counter_contactinfo]) && $_POST['cs_contact_animation'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	'cs_contact_animation="'.htmlspecialchars($_POST['cs_contact_animation'][$cs_counter_contactinfo]).'" ';
														}
														$shortcode .= 	']';
														
														if(isset($_POST['cs_contact_address'][$cs_counter_contactinfo]) && $_POST['cs_contact_address'][$cs_counter_contactinfo] != ''){
															$shortcode .= 	htmlspecialchars($_POST['cs_contact_address'][$cs_counter_contactinfo], ENT_QUOTES).' ';
														}
														
														$shortcode .= 	'[/cs_contactinfo]';
														
														$contactinfo->addChild('cs_shortcode', $shortcode );
														$cs_counter_contactinfo++;
													}
												$cs_global_counter_contactinfo++;
										}
												...
												if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
													...
													if(isset($_POST['cs_image_title'][$cs_counter_image]) && $_POST['cs_image_title'][$cs_counter_image] != ''){
														$shortcode .= 	'cs_image_title="'.htmlspecialchars($_POST['cs_image_title'][$cs_counter_image], ENT_QUOTES).'" ';
                                                                                                        ...
                                                                                                        if(isset($_POST['cs_image_link'][$cs_counter_image]) && $_POST['cs_image_link'][$cs_counter_image] != ''){
														$shortcode .= 	'cs_image_link="'.htmlspecialchars($_POST['cs_image_link'][$cs_counter_image], ENT_QUOTES).'" ';
