                    ...
                    <div class="tabs vertical">
                        <nav class="admin-navigtion">
                            <ul id="myTab" class="nav nav-tabs">
                                ...
                                <li><a href="#tab-subheader-options" data-toggle="tab"><i class="icon-header"></i> <?php _e('Sub Header Options','goalklub');?> </a></li>
                                ...
                                <?php }?>
                                <li><a href="#tab-post-options" data-toggle="tab"><i class="icon-list-alt"></i> <?php _e('Post Settings','goalklub');?> </a></li>
                       ...
                       <?php if($cs_builtin_seo_fields == 'on'){?>
                            <div id="tab-seo-advance-settings" class="tab-pane fade">
                                <div class="theme-help">
                                    <h4 style="padding-bottom:0px;"><?php _e('Seo Options','goalklub');?></h4>
                                    <div class="clear"></div>
                                </div>
			...
			if( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) return;
 			...
 			if ( ! function_exists( 'cs_blog_post_general_options' ) ) {
				...
				function cs_blog_post_general_options() {
                    ...
                    <li class="to-label"><label><?php _e('Thumbnail View','goalklub');?></label></li>
                    <li class="to-field">
                    	<div class="input-sec">
                            <div class="select-style">
                                <select name="post_thumb_view" class="dropdown" onchange="javascript:new_toggle(this.value)">
                                    <option <?php if($post_thumb_view=="Single Image")echo "selected";?> ><?php _e('Single Image','goalklub');?></option>
                                    <option <?php if($post_thumb_view=="Slider")echo "selected";?> ><?php _e('Slider','goalklub');?></option>
                                </select>
                            </div>
                        </div>
                        <div class="left-info">
                        ...
                        <ul class="form-elements" id="post_thumb_audio" style="display:<?php if($post_thumb_view=="Audio")echo 'inline"';else echo 'none';?>" >
                            <li class="to-label"><label><?php _e('Audio Url','goalklub');?></label></li>
                            <li class="to-field">
                            	<div class="input-sec">
                                    ...
                                    <label class="cs-browse">
                                    	<input type="button" id="post_thumb_audio2" name="post_thumb_audio2" class="uploadfile left" value="<?php _e('Browse','goalklub');?>"/>
                                    </label>
                                </div>
                                <div class="left-info">
                                	<p><?php _e('Enter Specific Audio Url (Youtube, Vimeo and all others wordpress supported)','goalklub');?></p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements" id="post_thumb_video" style="display:<?php if($post_thumb_view=="Video")echo 'inline"';else echo 'none';?>" >
                            <li class="to-label"><label><?php _e('Thumbnail Video Url','goalklub');?></label></li>
                            <li class="to-field">
                            	<div class="input-sec">
                                    ...
                                    <label class="cs-browse">
	                                    <input id="post_thumb_video2" name="post_thumb_video2" type="button" class="uploadfile left" value="<?php _e('Browse','goalklub');?>"/>
                                    </label>
                                </div>
                                <div class="left-info">
                                	<p><?php _e('Enter Specific Video Url (Youtube, Vimeo and all others wordpress supported) OR you can select it from your media library','goalklub');?></p>
                                </div>
                            </li>
                        </ul>
                </ul>
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Inside Post Thumbnail View','goalklub');?></label></li>
                        <li class="to-field">
                            <div class="input-sec">
                                <div class="select-style">
                                    <select name="inside_post_thumb_view" class="dropdown" onchange="javascript:new_toggle_inside_post(this.value)">
                                        <option <?php if($inside_post_thumb_view=="Single Image")echo "selected";?> ><?php _e('Single Image','goalklub');?></option>
                                        <option <?php if($inside_post_thumb_view=="Audio")echo "selected";?> ><?php _e('Audio','goalklub');?></option>
                                        <option <?php if($inside_post_thumb_view=="Video")echo "selected";?> value="Video"><?php _e('Video/Soundcloud','goalklub');?></option>
                                        <option <?php if($inside_post_thumb_view=="Slider")echo "selected";?> ><?php _e('Slider','goalklub');?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="left-info">
                                <p id="inside_post_thumb_image" style="display:<?php if($inside_post_thumb_view=="Single Image" or $inside_post_thumb_view=="")echo 'inline"';else echo 'none';?>"><?php _e('Use Featured Image as Thumbnail','goalklub');?></p>
                            </div>
                        </li>
                            <ul class="form-elements" id="inside_post_thumb_audio" style="display:<?php if($inside_post_thumb_view=="Audio")echo 'inline"';else echo 'none';?>" >
                                ...
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <label class="cs-browse">
                                            <input type="button" id="inside_post_thumb_audio2" name="inside_post_thumb_audio2" class="uploadfile left" value="<?php _e('Browse','goalklub');?>"/>
                                        </label>
                                    </div>
                                    <div class="left-info">
                                        <p><?php _e('Enter Specific Audio Url (Youtube, Vimeo and all others wordpress supported)','goalklub');?></p>
                            ...
                            <ul class="form-elements" id="inside_post_thumb_video" style="display:<?php if($inside_post_thumb_view=="Video")echo 'inline"';else echo 'none';?>" >
                                ...
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <label class="cs-browse">
                                            <input id="inside_post_thumb_video2" name="inside_post_thumb_video2" type="button" class="uploadfile left" value="<?php _e('Browse','goalklub');?>"/>
                                        </label>
                                    </div>
                                    <div class="left-info">
                                        <p><?php _e('Enter Specific Video Url (Youtube, Vimeo and all others wordpress supported) OR you can select it from your media library','goalklub');?></p>
