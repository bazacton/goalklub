...
if (!function_exists('cs_pricetable_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_pricetable', 'cs_pricetable_shortcode');
    }
...
if (!function_exists('cs_pricing_item')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('pricing_item', 'cs_pricing_item');
    }
...
if (!function_exists('cs_table_shortcode_func')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_table', 'cs_table_shortcode_func');
    }
...
if (!function_exists('cs_table_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('table', 'cs_table_shortcode');
    }
...
if (!function_exists('cs_table_body_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('tbody', 'cs_table_body_shortcode');
}
}
...
if (!function_exists('cs_table_head_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('thead', 'cs_table_head_shortcode');
}
}
...
if (!function_exists('cs_table_row_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('tr', 'cs_table_row_shortcode');
}
}
...
if (!function_exists('cs_table_heading_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('th', 'cs_table_heading_shortcode');
    }
...
if (!function_exists('cs_table_data_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('td', 'cs_table_data_shortcode');
    }
...
if (!function_exists('cs_accordion_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_accordian', 'cs_accordion_shortcode');
}
}
...
if (!function_exists('cs_accordion_item_shortcode')) {
	function cs_accordion_item_shortcode($atts, $content = "") {
		...
		if(isset($cs_accordian_icon)){
			$cs_accordian_icon_class = '<i class="'.$cs_accordian_icon.'"></i>';
		}
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('accordian_item', 'cs_accordion_item_shortcode');
}
}
...
if (!function_exists('cs_tabs_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_tabs', 'cs_tabs_shortcode');
}
}
...
if (!function_exists('cs_tab_item_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add( 'tab_item', 'cs_tab_item_shortcode' );
}
}
...
if (!function_exists('cs_toggle_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_toggle', 'cs_toggle_shortcode');
}
}
...
if (!function_exists('cs_button_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_button', 'cs_button_shortcode');
}
}
...
if (!function_exists('cs_counter_item_shortcode')) {
			...
			if($counter_style == 'icon-border'){
				...
				$output .= '<figure>
							  <figcaption>';
								...
								$counter_link_title = $counter_link_title ? $counter_link_title : __('Read More', 'goalklub');
				...
				if($counter_icon_type == 'icon' && $counter_icon <> ''){
					...
					$combine_counter_icon = '<img src="'.$cs_counter_logo.'" alt="No image">';
				}
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add( 'cs_counter', 'cs_counter_item_shortcode' );
}
}
...
if (!function_exists('cs_services_shortcode')) {
	function cs_services_shortcode( $atts, $content = null ) {
		...
		$defaults = array( 'column_size'=>'1/2', 'cs_service_type' => '','cs_service_icon_type' => '','cs_service_icon' => '','cs_service_icon_color' => '','cs_service_border'=>'','cs_service_bg_image' => '','cs_service_bg_color' => '','service_icon_size' => '','cs_service_postion_modern' => '','cs_service_postion_classic' => '','cs_service_title'=>'','cs_service_content' => '','cs_service_link_text' => '', 'cs_service_link_color'=>'','cs_service_btn_color'=>'','cs_service_url' => '', 'cs_service_class'=>'','cs_service_animation' => '');
		extract( shortcode_atts( $defaults, $atts ) );
		$column_class  = cs_custom_column_class($column_size);
		...
		if ($cs_service_type == 'modern'){
			...
			if ( isset( $cs_service_btn_color ) && $cs_service_btn_color !='' ) {
				$btn_bgclr = 'style="background-color: '.$cs_service_btn_color.' !important;"';
			} else{
				$btn_bgclr = '';
			}
		...
		$border_class = ($cs_service_border=='no')?'no_border':'has_border';
		$html	.= '<div class="col-md-12 '.$cs_service_animation.'" '.$CustomId.'>';
		$html	.= '<article class="cs-services '.$serviceClass.' '.$align.' '.$bgColorClass.' '.$border_class.'"  '.$bgColor.' >';
		if ( isset ( $cs_service_icon ) && $cs_service_icon !='' && $cs_service_icon_type == 'icon' ) {
			...
			$html	.= '<figure><img alt="No image" src="'.$cs_service_bg_image.'"></figure>';
		}
		
		$html	.= '<div class="text">';
		
		if ( isset ( $cs_service_title ) && $cs_service_title !='' ) {
			$html	.= '<h2 '.$linkColor.'>'.$cs_service_title.'</h2>';
		}
		...
		if ( isset ( $cs_service_url ) && $cs_service_url !='' ) {
			if ($cs_service_type == 'modern'){
				$html	.= '<a '.$btn_bgclr.' class="read-more" href="'.$cs_service_url.'">'.$more.' '.$LinkIcon.'</a>';
			}
			else{
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add( 'cs_services', 'cs_services_shortcode' );
}
}
...
if (!function_exists('cs_call_to_action_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('call_to_action', 'cs_call_to_action_shortcode');
}
}
//======================================================================
...
if (!function_exists('cs_progressbars_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_progressbars', 'cs_progressbars_shortcode');
}
}
...
if (!function_exists('cs_progressbar_item_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('progressbar_item', 'cs_progressbar_item_shortcode');
}
}
...
if (!function_exists('cs_piecharts_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_piechart', 'cs_piecharts_shortcode');
}
}
...
if (!function_exists('cs_faq_shortcode')) {
	...
	cs_shortcode_add('cs_faq', 'cs_faq_shortcode');
}
}
...
if (!function_exists('cs_faq_item_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('faq_item', 'cs_faq_item_shortcode');
}
}
