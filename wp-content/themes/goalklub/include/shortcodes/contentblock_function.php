...
if (!function_exists('cs_infobox_shortcode')) {
	...
	cs_shortcode_add('cs_infobox', 'cs_infobox_shortcode');
}
}

//======================================================================
// Adding Contactinfo start
//======================================================================

if (!function_exists('cs_contactinfo_shortcode')) {
	function cs_contactinfo_shortcode($atts, $content = "") {
		...
		$CustomId	= '';
		if ( isset( $cs_contact_class ) && $cs_contact_class ) {
			$CustomId	= 'id="'.$cs_contact_class.'"';
		}
		
		$html 			= '';
		$section_title = '';
		if ($cs_contact_section_title && trim($cs_contact_section_title) !='') {
			$section_title	= '<div class="cs-section-title"><h2>'.$cs_contact_section_title.'</h2></div>';
		}
		...
		$html .= '<div class="widget_text">';
		if ( isset ( $cs_contact_image ) && $cs_contact_image != '' ) {
			$html .= '<div class="logo"><a href="'.esc_url( home_url() ).'"><img src="'.$cs_contact_image.'" alt="No image" /></a></div>';
		}
         
		$html .= '<ul class="group">';
		$html .= '<li><i class="icon icon-list3"></i><p>'.do_shortcode(wp_specialchars_decode(nl2br($content))).'</p></li>';
		if(isset($cs_contact_phone) and $cs_contact_phone<>''){
			$html .= '<li><i class="icon icon-arrow-down12"></i><p>'.__('Phone','goalklub').wp_specialchars_decode($cs_contact_phone).'</p></li>';
		}
		if(isset($cs_contact_fax) and $cs_contact_fax<>''){
			$html .= '<li><i class="icon icon-circle-full"></i><p>'.__('Fax','goalklub').wp_specialchars_decode($cs_contact_fax).'</p></li>';
		}
		if(isset($cs_contact_email) and $cs_contact_email<>''){
			$html .= '<li><i class="icon icon-envelope-o"></i><p>'.__('Email','goalklub').wp_specialchars_decode($cs_contact_email).'</p></li>';
		}
		if(isset($cs_contact_web) and $cs_contact_web<>''){
			$html .= '<li><i class="icon icon-steam-square"></i><p>'.wp_specialchars_decode($cs_contact_web).'</p></li>';
		}
		$html .= '</ul></div>';
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_contactinfo', 'cs_contactinfo_shortcode');
}
}
...
if (!function_exists('cs_infobox_item_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('infobox_item', 'cs_infobox_item_shortcode');
}
}
...
if (!function_exists('cs_icons_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_icons', 'cs_icons_shortcode');
}
}
...
if (!function_exists('cs_map_shortcode')) {
	...
	if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_map', 'cs_map_shortcode');
}
}
...
if (!function_exists('cs_team_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_teamss', 'cs_team_shortcode');
}
}
...
if (!function_exists('cs_offerslider_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_offerslider', 'cs_offerslider_shortcode');
}
}
...
if (!function_exists('cs_offerslider_item')) {
	function cs_offerslider_item( $atts, $content = null ) {
		...
		if ( $cs_slider_image ) {
			...
			$html	.='<img  src="'.$cs_slider_image.'" alt="No image">';
			if ( $cs_readmore_link ) {
				$html	.='</a>';
			}
			$html	.='</figure>';
		...
		if ( $cs_readmore_link ) {
			$link_title	= $cs_offerslider_link_title ? $cs_offerslider_link_title : __('Get Directions','goalklub');
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add( 'offer_item', 'cs_offerslider_item' );
}
}
...
if (!function_exists('cs_spacer_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
	cs_shortcode_add('cs_spacer', 'cs_spacer_shortcode');
}
}
?>