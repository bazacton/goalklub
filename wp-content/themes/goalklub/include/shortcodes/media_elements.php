...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="column" data="<?php echo element_size_data_array_index($video_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_video {{attributes}}]{{content}}[/cs_video]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Video Options','goalklub');?></h5>
      ...
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <p><?php _e('give the video url here','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Width','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="video_width[]" class="txtfield" value="<?php echo esc_attr($video_width);?>" />
            <p><?php _e('Add a width in pix, If you want to override the default','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field">
            ...
            <p><?php _e('Provide height in px, if you want to override the default','goalklub');?> </p>
          </li>
        </ul>
        <?php 
	...
	function cs_pb_image($die = 0){
		...
		if ( isset($_POST['action']) && !isset($_POST['shortcode_element_id']) ) {
			...
			$output = $parseObject->cs_shortcodes( $output, $shortcode_str , true , $PREFIX );
 			...
 			$defaults = array( 'cs_image_section_title' => '','image_style' => '','cs_image_url' => '','cs_image_title' => '','cs_image_link' => '','cs_image_caption' => '','cs_image_custom_class'=>'','cs_image_custom_animation'=>'');
			if(isset($output['0']['atts']))
				$atts = $output['0']['atts'];
			else 
				$atts = array();
...
<div id="<?php echo cs_allow_special_char($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="image" data="<?php echo element_size_data_array_index($image_element_size); ?>" >
  ...
  <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter)?>" data-shortcode-template="[cs_image {{attributes}}]{{content}}[/cs_image]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Image Options','goalklub');?></h5>
    ...
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        ...
        <ul class="form-elements" style="display:none;">
          <li class="to-label">
            <label><?php _e('Image Style','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select class="image_style" name="image_style[]">
              <option <?php if($image_style == 'frame-plane'){echo 'selected="selected"';}?> value="frame-plane"><?php _e('Plain','goalklub');?></option>
              <option <?php if($image_style == 'frame-clean'){echo 'selected="selected"';}?> value="frame-clean"><?php _e('Clean','goalklub');?></option>
               <option <?php if($image_style == 'frame-classic'){echo 'selected="selected"';}?> value="frame-classic"><?php _e('Classic','goalklub');?></option>
              <option <?php if($image_style == 'frame-simple'){echo 'selected="selected"';}?> value="frame-simple"><?php _e('Simple','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Image Url','goalklub');?></label>
          </li>
          <li class="to-field">
            <input id="cs_image_url<?php echo esc_attr($rand_id)?>" name="cs_image_url[]" type="hidden" class="" value="<?php echo esc_url($cs_image_url);?>"/>
            <input name="cs_image_url<?php echo esc_attr($rand_id)?>"  type="button" class="uploadMedia left" value="<?php _e('Browse','goalklub');?>"/>
            <div class="left-info">
            <p><?php _e('Browse the image','goalklub');?> </p>
            </div>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Caption','goalklub');?></label>
          </li>
          <li class="to-field">
            ...
            <p><?php _e('If you would like a caption to be shown below the image, add it here','goalklub');?></p>
          </li>
        </ul>
             <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Image Link','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="cs_image_link[]" class="txtfield" value="<?php echo cs_allow_special_char($cs_image_link)?>" />
          </li>
        </ul>
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="promobox" data="<?php echo element_size_data_array_index($promobox_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_promobox {{attributes}}]{{content}}[/cs_promobox]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Promo box Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <input name="cs_promo_image_url<?php echo esc_attr($cs_counter)?>" type="button" class="uploadMedia left" value="<?php _e('Browse','goalklub');?>"/>
            <div class="left-info">
            
            <p><?php _e('Promo box Background image here','goalklub');?></p>
            </div>
          </li>
        </ul>
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Background Repeat','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select class="bg_repeat" name="bg_repeat[]">
              <option <?php if($bg_repeat == 'yes'){echo 'selected="selected"';}?> value="yes"><?php _e('Yes','goalklub');?></option>
              <option <?php if($bg_repeat == 'no'){echo 'selected="selected"';}?> value="no"><?php _e('No','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="text_align" name="text_align[]">
              <option <?php if($text_align == 'left'){echo 'selected="selected"';}?> value="left"><?php _e('Left','goalklub');?></option>
              <option <?php if($text_align == 'right'){echo 'selected="selected"';}?> value="right"><?php _e('Right','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <p><?php _e('Give external/internal promo box Url','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="slider" data="<?php echo element_size_data_array_index($slider_element_size)?>">
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_slider {{attributes}}]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Slider Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Slider Section Title','goalklub');?></label>
          </li>
          <li class="to-field">
            <div class="input-sec">
            ...
            <div class="left-info">
              <p><?php _e('Please enter slider header title','goalklub');?></p>
            </div>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Choose Slider','goalklub');?></label>
          </li>
          <li class="to-field">
            <div class="input-sec">
