...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="blog" data="<?php echo element_size_data_array_index($divider_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_divider {{attributes}}]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Divider Option','goalklub');?></h5>
    ...
    <div class="cs-pbwp-content">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select name="divider_style[]" class="dropdown" >
              <option <?php if($divider_style=="crossy")echo "selected";?> value="crossy" ><?php _e('Cross','goalklub');?></option>
              <option <?php if($divider_style=="plain")echo "selected";?> value="plain" ><?php _e('Plain','goalklub');?></option>
              <option <?php if($divider_style=="zigzag")echo "selected";?> value="zigzag" ><?php _e('Zigzag','goalklub');?></option>
              <option <?php if($divider_style=="small-zigzag")echo "selected";?> value="small-zigzag" ><?php _e('Small Zigzag','goalklub');?></option>
              <option <?php if($divider_style=="3box")echo "selected";?> value="3box" ><?php _e('3 Box','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Back to Top','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select name="divider_backtotop[]" class="dropdown" >
              <option value="yes" <?php if($divider_backtotop=="yes")echo "selected";?> ><?php _e('Yes','goalklub');?></option>
              <option value="no" <?php if($divider_backtotop=="no")echo "selected";?> ><?php _e('No','goalklub');?></option>
            </select>
            <p><?php _e('set back to top from the dropdown','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field">
            ...
            <p><?php _e('set margin top for the divider in px','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field">
            ...
            <p><?php _e('set a margin bottom for the divider in px','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field">
            ...
            <p><?php _e('set the divider height','goalklub');?></p>
          </li>
        </ul>
        <?php 
      ...
      <ul class="form-elements insert-bg">
        <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_','',$name);?>','<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" ><?php _e('Insert','goalklub');?></a> </li>
      </ul>
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="tooltip" data="<?php echo element_size_data_array_index($tooltip_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_tooltip {{attributes}}]{{content}}[/cs_tooltip]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Tooltip Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Hover Title','goalklub');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select name="tooltip_data_placement[]" class="dropdown" >
              <option <?php if($tooltip_data_placement=="top")echo "selected";?> value="top" ><?php _e('Top','goalklub');?></option>
              <option <?php if($tooltip_data_placement=="left")echo "selected";?> value="left" ><?php _e('Left','goalklub');?></option>
              <option <?php if($tooltip_data_placement=="bottom")echo "selected";?> value="bottom" ><?php _e('Bottom','goalklub');?></option>
              <option <?php if($tooltip_data_placement=="right")echo "selected";?> value="right" ><?php _e('Right','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="flex_column" data="<?php echo element_size_data_array_index($flex_column_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_column {{attributes}}]{{content}}[/cs_column]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Flex Column Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <?php
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Column Text','goalklub');?></label>
          </li>
          <li class="to-field">
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="blog" data="<?php echo element_size_data_array_index($dropcap_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_dropcap {{attributes}}]{{content}}[/cs_dropcap]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Drop cap Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select name="dropcap_style[]">
              <option <?php if($dropcap_style=="box")echo "selected";?> value="box" ><?php _e('Box','goalklub');?></option>
              <option <?php if($dropcap_style=="plain")echo "selected";?> value="plain" ><?php _e('Plain','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <p><?php _e('add your font size for the drop cap text','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <p><?php _e('Enter content here','goalklub');?></p>
          </li>
        </ul>
        <?php 
			if ( function_exists( 'cs_shortcode_custom_dynamic_classes' ) ) {
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="highlight" data="<?php echo element_size_data_array_index($highlight_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>"  data-shortcode-template="[cs_highlight {{attributes}}]{{content}}[/cs_highlight]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Highlight Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <ul class="form-elements">
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="heading" data="<?php echo element_size_data_array_index($heading_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>"  data-shortcode-template="[cs_heading {{attributes}}]{{content}}[/cs_heading]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Heading Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Color Title','goalklub');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <p><?php _e('add font size number for the heading','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field select-style">
            <select class="dropdown" name="heading_align[]">
              <option value="left" <?php if($heading_align=='left'){echo 'selected="selected"';}?>><?php _e('Left','goalklub');?></option>
              <option  value="center" <?php if($heading_align=='center'){echo 'selected="selected"';}?>><?php _e('Center','goalklub');?></option>
              <option value="right" <?php if($heading_align=='right'){echo 'selected="selected"';}?>><?php _e('Right','goalklub');?></option>
            </select>
            <p><?php _e('Align the content position','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Divider On/Off','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select class="dropdown" name="heading_divider[]">
              <option value="on" <?php if($heading_divider=='on'){echo 'selected="selected"';}?>><?php _e('On','goalklub');?></option>
              <option  value="off" <?php if($heading_divider=='off'){echo 'selected="selected"';}?>><?php _e('Off','goalklub');?></option>
            </select>
            <p><?php _e('set divider on/off for the list bottom border','goalklub');?> </p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Font Style','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select class="dropdown" name="heading_font_style[]">
              <option value="normal" <?php if($heading_font_style=='normal'){echo 'selected="selected"';}?>><?php _e('Normal','goalklub');?></option>
              <option value="italic" <?php if($heading_font_style=='italic'){echo 'selected="selected"';}?>><?php _e('Italic','goalklub');?></option>
              <option value="oblique" <?php if($heading_font_style=='oblique'){echo 'selected="selected"';}?>><?php _e('Oblique','goalklub');?></option>
            </select>
            <p><?php _e('select a font style from the drop down','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Heading Color','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="heading_color[]" class="bg_color"  value="<?php echo esc_attr($heading_color);?>" />
            <div class="left-info">
              <p><?php _e('heading color for the heading element','goalklub');?></p>
            </div>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Content Color','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="heading_content_color[]" class="bg_color"  value="<?php echo esc_attr($heading_content_color);?>" />
            <div class="left-info">
              <p><?php _e('set a content color for the heading element','goalklub');?></p>
            </div>
          </li>
        </ul>
        <ul class="form-elements">
...
<div id="<?php echo cs_allow_special_char($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="list" data="<?php echo element_size_data_array_index($list_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter)?>" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit List Style Options','goalklub');?></h5>
      ...
      <div class="cs-clone-append cs-pbwp-content" >
        <div id="shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>" data-shortcode-template="{{child_shortcode}} [/cs_list]" data-shortcode-child-template="[list_item {{attributes}}] {{content}} [/list_item]">
          <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true" data-template="[cs_list {{attributes}}]">
            ...
            <ul class="form-elements">
              <li class="to-label">
                <label><?php _e('List Style','goalklub');?></label>
              </li>
              <li class="to-field select-style">
                <select class="dropdown" id="cs_list_type_selected" name="cs_list_type[]" onchange="cs_toggle_list(this.value,'cs_slider_height<?php echo cs_allow_special_char($name.$cs_counter)?>')">
                  <option value="none" <?php if($cs_list_type =="none")echo "selected";?>><?php _e('None','goalklub');?></option>
                  <option value="icon" <?php if($cs_list_type =="icon")echo "selected";?>><?php _e('Icon','goalklub');?> </option>
                  <option value="built" <?php if($cs_list_type =="built")echo "selected";?>><?php _e('Bullet','goalklub');?></option>
                  <option value="decimal" <?php if($cs_list_type =="decimal") echo "selected";?> ><?php _e('Decimal','goalklub');?></option>
                  <option value="alphabatic" <?php if($cs_list_type =="alphabatic")echo "selected";?>><?php _e('Alphabetic','goalklub');?> </option>
                  <option value="numeric-icon" <?php if($cs_list_type =="numeric-icon")echo "selected";?>><?php _e('Numeric and Icon','goalklub');?> </option>
                  <!-- <option value="custom_icon">Custom Icon</option>-->
                </select>
                <p><?php _e('set a list style from the dropdown','goalklub');?></p>
              </li>
            </ul>
            <ul class="form-elements">
              <li class="to-label">
              ...
              <li class="to-field select-style">
                <select class="dropdown" name="cs_border[]">
                  <option <?php if($cs_border == "yes")echo "selected";?> value="yes"><?php _e('Yes','goalklub');?></option>
                  <option value="no" <?php if($cs_border == "no")echo "selected";?>><?php _e('No','goalklub');?></option>
                </select>
                <p><?php _e('set on/off for the list bottom border','goalklub');?> </p>
              </li>
            </ul>
            <?php 
				if ( function_exists( 'cs_shortcode_custom_dynamic_classes' ) ) {
          ...
          <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo esc_attr($rand_id);?>">
            <header>
              <h4><i class='icon-arrows'></i><?php _e('List Item(s)','goalklub');?></h4>
              <a href='#' class='deleteit_node'><i class='icon-minus8-circle'></i><?php _e('Remove','goalklub');?></a></header>
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('List Item','goalklub');?></label>
              </li>
              <li class='to-field'>
                <div class='input-sec'>
        ...
        <div class="wrapptabbox no-padding-lr">
          <div class="opt-conts">
            <ul class="form-elements">
              <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('list', 'shortcode-item-<?php echo esc_js($cs_counter);?>', '<?php echo admin_url('admin-ajax.php');?>')"><i class="icon-plus7"></i><?php _e('Add List Item','goalklub');?></a> </li>
              <div id="loading" class="shortcodeload"></div>
            </ul>
          </div>
          <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
          <ul class="form-elements insert-bg noborder">
            <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_','',$name);?>','shortcode-item-<?php echo esc_js($cs_counter);?>','<?php echo esc_js($filter_element);?>')" ><?php _e('Insert','goalklub');?></a> </li>
          </ul>
          <div id="results-shortocde"></div>
          <?php } else {?>
...
<div id="<?php echo cs_allow_special_char($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="mesage" data="<?php echo element_size_data_array_index($message_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter)?>" data-shortcode-template="[cs_message {{attributes}}]{{content}}[/cs_message]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Message Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo cs_allow_special_char($name.$cs_counter)?>','<?php echo cs_allow_special_char($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Message Type','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select id="cs_message_type<?php echo cs_allow_special_char($cs_counter)?>" name="cs_message_type[]" onchange="cs_toggle_alerts(this.value,<?php echo cs_allow_special_char($cs_counter)?>)">
              <option <?php if($cs_message_type=="alert")echo "selected";?> value="alert" ><?php _e('Alert','goalklub');?></option>
              <option <?php if($cs_message_type=="message")echo "selected";?> value="message" ><?php _e('Message','goalklub');?></option>
            </select>
            <p><?php _e('Select the display type for the Message','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements" id="cs_alerts_style<?php echo cs_allow_special_char($cs_counter)?>" style="display:none">
          <li class="to-label">
            <label><?php _e('Message Style','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select name="cs_alert_style[]" id="cs_alert_style<?php echo cs_allow_special_char($cs_counter)?>" onchange="cs_toggle_fancyalert(this.value,<?php echo cs_allow_special_char($cs_counter)?>)">
              <option <?php if($cs_alert_style=="normal_messagebox")echo "selected";?> value="normal_messagebox" ><?php _e('Normal','goalklub');?></option>
              <option <?php //if($cs_alert_style=="threed_messagebox")echo "selected";?> selected  value="threed_messagebox" ><?php _e('3D Style','goalklub');?></option>
            </select>
          </li>
        </ul>
        ...
        <div id="fancy_active<?php echo intval($cs_counter)?>">
          ...
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('Message Box Title','goalklub');?></label>
            </li>
            <li class="to-field">
        ...
        <ul class="form-elements" id="cs_style_type<?php echo intval($cs_counter)?>" style="display:none">
          <li class="to-label">
            <label><?php _e('Style Type','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select name="cs_style_type[]" >
              <option <?php if($cs_style_type == "fancy")echo "selected";?> value="fancy" ><?php _e('Fancy','goalklub');?></option>
              <option <?php if($cs_style_type == "plain")echo "selected";?> value="plain" ><?php _e('Plain','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Close Button','goalklub');?></label>
          </li>
          <li class="to-field">
            <div class="select-style">
              <select name="cs_message_close[]">
                <option <?php if($cs_message_close=="yes")echo "selected";?> value="yes" ><?php _e('Yes','goalklub');?></option>
                <option <?php if($cs_message_close=="no")echo "selected";?> value="no" ><?php _e('No','goalklub');?></option>
              </select>
              <p><?php _e('Set close button on/off','goalklub');?></p>
            </div>
          </li>
        </ul>
        <ul class="form-elements">
...
<div id="<?php echo cs_allow_special_char($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="testimonials" data="<?php echo element_size_data_array_index($testimonials_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter)?>" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Testimonials Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo cs_allow_special_char($name.$cs_counter)?>','<?php echo cs_allow_special_char($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
      <div class="cs-clone-append cs-pbwp-content">
      <div class="cs-wrapp-tab-box">
        <div id="shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>" data-shortcode-template="{{child_shortcode}} [/cs_testimonials]" data-shortcode-child-template="[testimonial_item {{attributes}}] {{content}} [/testimonial_item]">
              ...
              <li class='to-field'>
                <div class='input-sec select-style'>
                  <select name='testimonial_style[]' class='dropdown'>
                    <option value='simple' <?php if($testimonial_style == 'simple'){echo 'selected';}?>><?php _e('Classic Slider','goalklub');?> </option>
                    <option value='fancy' <?php if($testimonial_style == 'fancy'){echo 'selected';}?>><?php _e('Modern Slider','goalklub');?> </option>
                    <option value='slider' <?php if($testimonial_style == 'slider'){echo 'selected';}?>><?php _e('Simple Slider','goalklub');?> </option>
                  </select>
                </div>
                <div class='left-info'>
                  <p><?php _e('Testimonial Style','goalklub');?></p>
                </div>
              </li>
            </ul>
            <ul class="form-elements">
              ...
              <li class="to-field select-style">
                <select name="cs_testimonial_text_align[]" class="dropdown" >
                  <option <?php if($cs_testimonial_text_align=="left")echo "selected";?> ><?php _e('left','goalklub');?></option>
                  <option <?php if($cs_testimonial_text_align=="right")echo "selected";?> ><?php _e('right','goalklub');?></option>
                  <option <?php if($cs_testimonial_text_align=="center")echo "selected";?> ><?php _e('center','goalklub');?></option>
                </select>
                <p><?php _e('This will not apply in Slider View','goalklub');?></p>
              </li>
            </ul>
            <ul class="form-elements">
              <li class="to-label">
          ...
          <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo cs_allow_special_char($rand_string);?>">
            <header>
              <h4><i class='icon-arrows'></i><?php _e('Testimonial','goalklub');?></h4>
              <a href='#' class='deleteit_node'><i class='icon-minus8-circle'></i><?php _e('Remove','goalklub');?></a></header>
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('Text','goalklub');?></label>
            ...
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('Author','goalklub');?></label>
              </li>
              <li class='to-field'>
                <div class='input-sec'>
            ...
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('Company','goalklub');?></label>
              </li>
              <li class='to-field'>
                <div class='input-sec'>
                ...
                <div class='left-info'>
                  <p><?php _e('Company Name','goalklub');?></p>
                </div>
              </li>
            </ul>
            <ul class="form-elements">
              ...
              <li class="to-field">
                ...
                <input name="testimonial_img<?php echo cs_allow_special_char($rand_string)?>"  type="button" class="uploadMedia left" value="<?php _e('Browse','goalklub');?>"/>
              </li>
            </ul>
        ...
        <div class="wrapptabbox cs-pbwp-content" style="padding:0">
          <div class="opt-conts">
            <ul class="form-elements">
              <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('testimonials', 'shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>', '<?php echo admin_url('admin-ajax.php');?>')"><i class="icon-plus7"></i><?php _e('Add testimonials','goalklub');?></a> </li>
              <div id="loading" class="shortcodeload"></div>
            </ul>
            <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
            <ul class="form-elements insert-bg noborder">
              <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo str_replace('cs_pb_','',$name);?>','shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>','<?php echo cs_allow_special_char($filter_element);?>')" ><?php _e('Insert','goalklub');?></a> </li>
            </ul>
            <div id="results-shortocde"></div>
            <?php } else {?>
            <ul class="form-elements noborder">
...
<div id="<?php echo cs_allow_special_char($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="column" data="<?php echo element_size_data_array_index($quote_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter)?>"  data-shortcode-template="[cs_quote {{attributes}}]{{content}}[/cs_quote]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Quote Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <div class="cs-pbwp-content cs-wrapp-tab-box">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field">
              ...
              <p><?php _e('Give the name of the Author','goalklub');?></p>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('Author Url','goalklub');?></label>
            </li>
            <li class="to-field">
              <input type="text" name="quote_cite_url[]" class="txtfield" value="<?php echo esc_url($quote_cite_url);?>" />
              <p><?php _e('Give the Author External/Internal Url','goalklub');?></p>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
          ...
          <ul class="form-elements">
            ...
            <li class="to-field select-style">
              <select name="quote_align[]" class="dropdown" >
                <option <?php if($quote_align=="left")echo "selected";?> ><?php _e('left','goalklub');?></option>
                <option <?php if($quote_align=="right")echo "selected";?> ><?php _e('right','goalklub');?></option>
                <option <?php if($quote_align=="center")echo "selected";?> ><?php _e('center','goalklub');?></option>
              </select>
              <p><?php _e('Align the content position','goalklub');?></p>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('Quote Content','goalklub');?></label>
            </li>
            <li class="to-field">
...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="contactus" data="<?php echo element_size_data_array_index($contactus_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[cs_contactus {{attributes}}]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Contact Form Options','goalklub');?></h5>
      <a href="javascript:removeoverlay('<?php echo esc_js($name.$cs_counter)?>','<?php echo esc_js($filter_element);?>')" class="cs-btnclose"><i class="icon-cross3"></i></a> </div>
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>
        ...
        <ul class="form-elements">
          ...
          <li class="to-field select-style">
            <select class="cs_contactus_view" id="cs_contactus_view" name="cs_contactus_view[]">
              <option <?php if($cs_contactus_view == "plain")echo "selected";?> value="plain"><?php _e('Plain','goalklub');?></option>
              <option <?php if($cs_contactus_view == "fancy")echo "selected";?> value="fancy"><?php _e('Fancy','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Label On/Off','goalklub');?></label>
          </li>
          <li class="to-field select-style">
            <select class="cs_contactus_label" id="cs_contactus_label" name="cs_contactus_label[]">
              <option <?php if($cs_contactus_label == "on")echo "selected";?> value="on"><?php _e('On','goalklub');?></option>
              <option <?php if($cs_contactus_label == "off")echo "selected";?> value="off"><?php _e('Off','goalklub');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Send To','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="cs_contactus_send[]" class="txtfield" value="<?php echo esc_attr($cs_contactus_send);?>" />
            <p><?php _e('add a email which you want to receive email','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Mail Success','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="cs_success[]" class="txtfield" value="<?php echo esc_attr($cs_success);?>" />
            <p><?php _e('set a message if your email sent successfully','goalklub');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Error Message','goalklub');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="cs_error[]" class="txtfield" value="<?php echo esc_attr($cs_error);?>" />
            <p><?php _e('set a message for error message','goalklub');?></p>
          </li>
        </ul>
