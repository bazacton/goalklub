...
?>
   ...
   <div class="cs-demo-data">
        ...
        <h2><?php _e('Import Demo Data','goalklub');?></h2>

        

        <div class="inn-text">

            <p><?php _e('Importing demo data helps to build site like the demo site by all means. It is the quickest way to setup theme. Following things happen when dummy data is imported','goalklub');?></p>

            <ul class="import-data">

                <li>&#8226; <?php _e('All wordpress settings will remain same and intact','goalklub');?></li>

                <li>&#8226; <?php _e('Posts, pages and dummy images shown in demo will be imported','goalklub');?></li>

                <li>&#8226;<?php _e('Only dummy images will be imported as all demo images have copy right restriction','goalklub');?> </li>

                <li>&#8226;<?php _e('No existing posts, pages, categories, custom post types or any other data will be deleted or modified','goalklub');?> </li>

                <li>&#8226; <?php _e('To proceed, please click "Import Demo Data" and wait for a while','goalklub');?></li>
...
function cs_update_themeoptions($page ='',$formdata = '',$theme_option = ''){
	if(isset($page->ID)){
		...
		$cs_theme_skin = unserialize((function_exists('base_64_decode')) ? base_64_decode($theme_option) : "");
