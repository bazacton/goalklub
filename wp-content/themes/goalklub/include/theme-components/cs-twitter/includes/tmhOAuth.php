...
class tmhOAuth {
    ...
    private function prepare_oauth_signature() {
        $this->request_settings['oauth1_params']['oauth_signature'] = $this->safe_encode(
            (function_exists('base_64_encode')) ? base_64_encode( hash_hmac('sha1', $this->request_settings['basestring'], $this->request_settings['signing_key'], true)) : ""
              );
    }
    ...
    public function bearer_token_credentials() {
        ...
        return (function_exists('base_64_encode')) ? base_64_encode($credentials) : "";
    }
