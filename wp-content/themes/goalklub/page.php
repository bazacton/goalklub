...
if ( ! isset( $cs_xmlObject->cs_page_sidebar_styling ) )
	$cs_page_sidebar_styling = "";
else
	$cs_page_sidebar_styling = $cs_xmlObject->cs_page_sidebar_styling;

if ( ! isset( $cs_xmlObject->cs_page_sidebar_styling_color ) )
...
if ( isset( $cs_xmlObject ) && $cs_xmlObject) {
		...
		if ( get_the_content() <> '' || $image_url <> '' ) {
			...
			<section class="page-section">
				<div  class="container">
								...
								<a href="<?php echo esc_url( $image_url ); ?>">
									<figure>
										<div class="page-featured-image">
											<img class="img-thumbnail" title="image" alt="No image" data-src="" style="width: 100%; " src="<?php echo esc_url( $image_url ); ?>">
										</div>
									</figure>
								</a>
								<?php
					...
					<?php  echo comments_template('/comments.php',true); ?>
					</div>
				</div>
			</section>
			<?php
				...
				<div  class="<?php echo esc_attr( $cs_section_view ); ?>">
					...
					<div class="row">
						...
						if ( isset( $cs_layout ) && $cs_layout == "left" && $cs_sidebar_left <> '' ) {
							...
							$cs_sidebar_style = '';
							if ( $cs_page_sidebar_styling == 'box' ) {
								$cs_sidebar_class = ' class="box"';
							} else if ( $cs_page_sidebar_styling == 'color' ) {
								$cs_sidebar_class = ' class="color"';
							}
							if ( $cs_page_sidebar_styling_color <> '' ) {
								$cs_sidebar_style = ' style="background-color:' . $cs_page_sidebar_styling_color . ';"';
							}
							if ( $cs_sidebar_class <> '' || $cs_sidebar_style <> '' )
								echo '<div' . cs_allow_special_char( $cs_sidebar_class ) . cs_allow_special_char( $cs_sidebar_style ) . '>';
